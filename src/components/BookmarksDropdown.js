...
const BookmarksDropdown = ({ changeBookmarksDropdown, bookmarks, updatedBookmarks }) => {
    ...
    return (
        <div className="bookmarks" onMouseLeave={() => changeBookmarksDropdown(false)}>
            {modifiedBookmarks.length === 0 && <p className="bookmarks-empty">You have no bookmarks. Find a recipe you like, and bookmark it!</p>}
